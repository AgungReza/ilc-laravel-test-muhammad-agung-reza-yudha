        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div
                x-data="goodsIssueForm({
                    ...
                    initialLines: @js(old('items', $goodsIssue->items->map(fn ($line) => [
            ...
            >
                <form action="{{ route('goods-issues.update', $goodsIssue) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-gray-800 p-6 shadow-sm sm:p-8">
                        ...
                        <div class="mt-6 rounded-xl border border-amber-200 bg-amber-50 dark:bg-amber-900/30 p-4 text-sm text-amber-800 dark:text-amber-300">
                            ...
                            baru, sehingga total stok yang sebenarnya tersedia untuk
                            diedit lebih besar dari yang tertampil.
                        </div>
