...
class StoreGoodsIssueRequest extends FormRequest
{
     ...
     * Validation Rules
     *
     * Catatan: kecukupan stok TIDAK divalidasi di sini, melainkan di
     * controller di dalam DB::transaction() dengan lockForUpdate(),
     * supaya aman dari race condition saat dua transaksi Barang Keluar
     * diinput bersamaan untuk kombinasi barang+supplier yang sama.
     */
     ...
     * barang + supplier yang sama dalam satu transaksi. Kalau butuh
     * jumlah lebih banyak, gabungkan saja ke satu baris.
     */
